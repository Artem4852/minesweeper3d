...
# Metal detector
metal_detector = Entity(model='models/metal_detector.glb', position=(5, 1.2, 5), scale=1, cast_shadows=True)
metal_detector_arrow = Entity(model='models/metal_detector_arrow.glb', position=(0, 1.68, -0.97), scale=1, cast_shadows=True, parent=metal_detector)
# metal_detector_arrow = Entity(model='models/metal_detector_arrow.glb', position=(0, 3.36, -1.93), scale=1, cast_shadows=True, parent=metal_detector)
